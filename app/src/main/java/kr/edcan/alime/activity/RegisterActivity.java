    ...
    private void setDefault() {
        ...
        binding.registerRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(!binding.registerPassword.getText().toString().trim().isEmpty() &&
                        !binding.registerId.getText().toString().trim().isEmpty() &&
                        !binding.registerName.getText().toString().trim().isEmpty() &&
                        !binding.registerRePassword.getText().toString().trim().isEmpty()) {
                    if (binding.registerPassword.getText().toString().trim().equals(binding.registerRePassword.getText().toString().trim())) {
                ...
                } else Toast.makeText(RegisterActivity.this, "공백 없이 입력해주세요!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}
